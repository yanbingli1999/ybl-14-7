...
export const INITIAL_TRAIN: Train = {
  ...
  carriages: [
    ...
    { id: 'car-bomb', candyType: 'bomb', capacity: 5, currentLoad: 0 },
    { id: 'car-rainbow', candyType: 'rainbow', capacity: 3, currentLoad: 0 },
  ],
};
...
export const STATION_SHEET_MUSIC: Record<string, StationSheetMusic[]> = {
  ...
  'lemon-estate': [
    ...
    },
    {
      ...
      name: '柠檬水之歌',
      pattern: ['do', 'mi', 'fa'],
      reward: { type: 'return_candy', value: 3, description: '返还3颗柠檬糖或1颗炸弹糖' },
      difficulty: 'hard',
    },
  ],
  'mint-forest': [
    ...
    },
    {
      ...
      name: '林间回响',
      pattern: ['fa', 'mi', 're', 'do'],
      reward: { type: 'return_candy', value: 2, description: '返还2颗炸弹糖' },
      difficulty: 'hard',
    },
  ],
  'blueberry-port': [
    ...
    },
    {
      ...
      name: '浪花华尔兹',
      pattern: ['do', 're', 'mi', 'fa'],
      reward: { type: 'return_candy', value: 1, description: '返还1颗彩虹糖' },
      difficulty: 'hard',
    },
  ],
  'grape-castle': [
    ...
    },
    {
      ...
      reward: { type: 'return_candy', value: 2, description: '返还2颗炸弹糖+1颗彩虹糖' },
      difficulty: 'hard',
    },
  ],
};
